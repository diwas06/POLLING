...
if($conn->connect_error){
 ...
 $sql = "select * from question order by yesCount DESC, questionId ASC";
     $result=$conn->query($sql);
    // echo "<caption>sample caption</caption>";
     echo "<button onclick=".$com."window.location.href = 'sortY.php';".$com." id='yes' disabled>sort by yes</button>";
